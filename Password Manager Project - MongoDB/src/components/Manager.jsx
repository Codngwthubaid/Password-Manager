    ...
    return (
        <>
            ...
            <div className='flexcontainer'>
                <div className='mx-auto container px-44 flex flex-col text-black h-[82vh] bg-green-50 '>
                            ...
                            <section class="mx-auto container ">
                                <div className='bg-green-800 text-white rounded-lg'>
                                    <div className='flex justify-start items-center'>
                                        ...
                                        <div className='w-[200px] text-center py-2 font-semibold text-lg cursor-pointer'>Username</div>
                                        <div className='w-[200px] text-center py-2 font-semibold text-lg cursor-pointer'>Password</div>
                                        <div className='w-[100px] text-center py-2 font-semibold text-lg cursor-pointer'>Actions</div>
                                    </div>
                                </div>
                                    ...
                                    {passwordsArray.map((item, key) => {
                                        return (
                                            <div key={key} className='flex'>
                                                ...
                                                <div className='py-2 border border-white w-[200px] flex justify-center items-center'>
                                                ...
                                                <div className='py-2 border border-white w-[100px] flex justify-center items-center'>
